...
No. ManyChat's API does not support flow creation. The Flow Heist generates a step-by-step rebuild guide that you follow in the ManyChat UI. Think of it as a detailed recipe, not a robot chef.
...
You can screenshot anything you can see on your screen. The Flow Heist doesn't access paid content -- it analyzes screenshots you provide. Use your judgement about sharing copyrighted material.
...
Ads Machine researches what ads to run. Flow Heist builds the automation that captures leads from those ads. Ads Machine drives traffic, Flow Heist converts it.

**Q: How does this work with the Agency Command Centre?**
ACC tracks client performance. Flow Heist builds the client's automation flows. ACC tells you if the funnel is leaking, Flow Heist helps you fix it.
